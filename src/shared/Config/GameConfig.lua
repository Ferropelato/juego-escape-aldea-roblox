...
GameConfig.Challenges = {
	...
	JungleMaze = {
		...
		description = "Recolectá lianas en la entrada y encontrá la salida del laberinto",
		difficulty = 2,
		checkpointId = "CP_Jungle",
		requiredChallenge = "BeachLanding",
		requiredCraft = nil,
		zoneSize = Vector3.new(250, 60, 200),
		puzzleType = "Maze",
		objectives = {
			{ type = "collect", resource = "Vine", amount = 2, text = "Recolectar 2 lianas (están en la entrada del laberinto)" },
			{ type = "reach", text = "Encontrar la salida verde al este del laberinto" },
		},
	},
	RiverCross = {
		id = "RiverCross",
